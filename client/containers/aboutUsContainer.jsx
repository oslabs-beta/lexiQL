...
export default function aboutUsContainer() {
  const teamMembers = [
    ...
    { name: 'Chris Carney', headshot: chrisHeadshot, github: 'https://github.com/Carthanial', linkedin: 'https://www.linkedin.com' },
    { name: 'Stacy Learn', headshot: stacyHeadshot, github: 'https://github.com/hello-stacy', linkedin: 'https://www.linkedin.com/in/stacy-learn/' },
    { name: 'John Li', headshot: johnHeadshot, github: 'https://github.com/john-li7', linkedin: 'https://www.linkedin.com/in/john-li-cpa-7327a380/' },
    { name: 'Ryan McDaniel', headshot: ryanHeadshot, github: 'https://github.com/ryanmcd118', linkedin: 'https://www.linkedin.com/in/ryanpmcdaniel/' }
  ];
